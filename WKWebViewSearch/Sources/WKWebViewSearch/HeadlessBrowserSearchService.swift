...
struct HeadlessBrowserSearchService: SearchService, Sendable {
...
enum GoogleSearchResultParser: Sendable {
...
enum BaiduSearchResultParser: Sendable {
    static func validate(document: SwiftSoup.Document) -> Bool {
    ...
    static func getRealLink(from baiduLink: String) async -> String {
        ...
        do {
            ...
            if let finalURL = await redirectCapturer.finalURL {
...
enum DuckDuckGoSearchResultParser: Sendable {
    static func validate(document: SwiftSoup.Document) -> Bool {
...
enum BingSearchResultParser: Sendable {
    static func validate(document: SwiftSoup.Document) -> Bool {
